...
function FilterBar({ peminatanList, periods }) {
    FilterBar.propTypes = {
    ...
    const filterPeriodId = searchParams.get('periodId');
    return (
        <div>
            <div className="form-group">
                <label htmlFor="peminatanId">Periode</label>
                <PeriodSelect
                    name="periodId"
                    periods={periods}
...
function Page() {
    const { topicSelections, peminatanList, periods } = window.SAILS_LOCALS;
    return (
        <div className="page main-content-container px-4 pb-4 container-fluid">
            {/* <Navbar activeMenu={ADMIN_MENU.TOPIC_SELECTION_ARCHIVES} /> */}
            <div className="container">
                <div className="content">
                    <h1>Daftar Pemilihan Topik</h1>
                    <FilterBar peminatanList={peminatanList} periods={periods} />
                    <TopicSelectionTable
