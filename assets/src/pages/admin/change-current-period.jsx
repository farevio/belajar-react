...
class PeriodForm extends React.Component {
    ...
    handleSubmit(e) {
        e.preventDefault();
        const currentPeriod = this.props.currentPeriod;
        const alertMessage = currentPeriod
            ? `\ndari ${currentPeriod.semester} ${currentPeriod.academicYear} \nmenjadi ${this.state.semester} ${this.state.academicYear}`
            : `\nmenjadi${this.state.semester} ${this.state.academicYear}`
        if (!confirm('Apakah anda yakin akan mengganti periode' + alertMessage)) return;
                ...
                <div>
                    ...
                    <form name="period" onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" name="academicYear" onChange={this.handleChange} />
                        </div>
